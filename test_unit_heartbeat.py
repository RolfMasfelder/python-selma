...
def test_parse_minutes():
    from heartbeat import parse_interval_seconds
...
def test_active_hours_always_open():
    ...
    from config import ActiveHoursConfig
...
def test_empty_none_not_empty():
    ...
    from heartbeat import is_heartbeat_content_effectively_empty
...
def test_strip_none_is_ack():
    from heartbeat import strip_heartbeat_token
...
def test_heartbeat_config_with_active_hours():
    from config import HeartbeatConfig, ActiveHoursConfig
    cfg = HeartbeatConfig(
        every="1h",
